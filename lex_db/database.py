...
from lex_db.embeddings import generate_embeddings, get_embedding_dimensions, generate_query_embedding
...
def create_vector_index(
    ...
    for idx, (article_rowid, text_content) in enumerate(articles, 1):
        ...
        for i, (chunk_text, chunk_embedding) in enumerate(zip(chunks, chunk_embeddings)):
            ...
            cursor.execute(insert_sql, (json.dumps(chunk_embedding), str(article_rowid), i))
...
def search_vector_index(
    ...
    query_vector = generate_query_embedding(query_text, model_choice=embedding_model_choice)
